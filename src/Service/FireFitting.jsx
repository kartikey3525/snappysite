        ...
        <div className="container text-center ">
          ...
          >
            ...
            <p className="text-left" style={{ fontSize: "20px" }}>
              Professional Firefitting Contracting Services: Safeguarding Your
              Property with Expert Fire Protection Welcome to our premier
              firefitting contracting services! Ensuring that your property is
              equipped with effective fire protection systems is essential for
              safety and peace of mind. Our team is dedicated to providing
              comprehensive firefitting solutions to safeguard your home,
              business, or industrial facility from fire hazards.
            </p>
          </div>
      ...
      <section id="What_offer">
        <div className="container text-justify">
          <div className="row">
            {/* content  */}
            <p className="text-left" style={{ fontSize: "20px" }}>
              What is Firefitting Contracting? Firefitting Contracting involves
              the design, installation, maintenance, and repair of fire
              protection systems. These systems are critical for detecting,
              controlling, and extinguishing fires, helping to protect lives and
              property. Our expert services ensure that your fire protection
              systems are up-to-date, compliant with regulations, and ready to
              perform when needed.
            </p>
            <h1
            ...
            <div style={{ overflow: "hidden" }}>
              ...
              <p className="text-left" style={{ fontSize: "20px" }}>
                ...
                assessment. Our systems are designed to provide optimal coverage
                and reliability.
              </p>
              <p className="text-left" style={{ fontSize: "20px" }}>
                Fire Alarm Systems: We offer installation of advanced fire alarm
                systems that include smoke detectors, heat detectors, and alarm
                panels to ensure early detection and prompt response to fire
                incidents.
              </p>
              <p className="text-left" style={{ fontSize: "20px" }}>
                Fire Extinguishers: Our team installs and services various types
                of fire extinguishers, including water, foam, CO2, and dry
                powder extinguishers, based on the specific fire risks present
                in your facility.
              </p>{" "}
              <p className="text-left" style={{ fontSize: "20px" }}>
            ...
            <div style={{ overflow: "hidden" }}>
              {/* <img
                ...
                /> */}
              <p className="text-left" style={{ fontSize: "20px" }}>
                Routine Inspections: Regular inspections are essential to ensure
                that fire protection systems are functioning correctly and
                comply with safety regulations. We conduct thorough inspections
              ...
              <p className="text-left" style={{ fontSize: "20px" }}>
                ...
                issues identified during inspections or as reported by facility
                staff, ensuring that your fire protection systems are always in
            ...
            <div style={{ overflow: "hidden" }}>
              {/* <img
                ...
                /> */}
              <p className="text-left" style={{ fontSize: "20px" }}>
                Modernization: We offer upgrading services to modernize outdated
                fire protection systems, enhancing their effectiveness and
            ...
            <div style={{ overflow: "hidden" }}>
              ...
              <p className="text-left" style={{ fontSize: "20px" }}>
                ...
                emergency situations, minimizing downtime and ensuring that your
                fire protection systems are restored to full functionality as
                soon as possible.
              </p>
            </div>
            ...
            <div className="col-md-6 col-sm-6 col-xs-12 text-left">
              <div className="qa_box_one">
                <div className="question">
                  <strong>Q.</strong>
                  <h4>
                    Who can design, install, and maintain electrical systems in
                    my home?{" "}
                  </h4>
                </div>
                <div className="answer">
                  ...
                  <p>
                    ...
                    electrical contractor. All installation must be inspected by
                    the city, district, area electrical inspector. Contact your
                    local government electricity board authorities for rules and
                    regulations. It is best you a hire a licensed electrician.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 col-sm-6 col-xs-12 text-left">
              <div className="qa_box_one">
                ...
                <div className="answer">
                  <strong>A.</strong>
                  <p>
                    Signs noise Overheating frosting of polished metal surfaces
                    premature grease darkening. Possible causes Leakage current
                    from the armature windings, Non-symmetrical magnetic fields
